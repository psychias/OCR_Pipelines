# Paper: ACL 2025
# Evaluates: CLSD monolingual noise evaluation with E5
import os
import pandas as pd
...
def process_and_save_results(tasks):
    ...
    save_name_predictions = "MONO_e5-multilingual-base_all_predictions.csv"
    ...
    tasks = [
        {
            ...
            "prefixes": [
                "intfloat_multilingual-e5-base-mono-10000-samples-seed",
            ],
            "levels": {
