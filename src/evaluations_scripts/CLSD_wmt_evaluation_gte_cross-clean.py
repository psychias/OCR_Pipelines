# Paper: ACL 2025
# Evaluates: CLSD cross-noise evaluation with GTE (clean distractors)
import os
import pandas as pd
...
def process_and_save_results(tasks):
    ...
    for task in tasks:
        ...
        save_name = (
            "CROSS-CLEAN_gte-multilingual-base"
            + "-".join(levels.keys())
            + eval_dataset
    ...
    save_name_predictions = "CROSS-CLEAN_gte-multilingual-base_all_predictions.csv"
    ...
    tasks = [
        {
            ...
            "prefixes": [
                "Alibaba-NLP_gte-multilingual-base-cross_clean-10000-samples-seed",
            ],
            "levels": {
