# Paper: ACL 2025
# Evaluates: CLSD monolingual evaluation with GTE (SNP noise)
import os
import pandas as pd
...
def process_and_save_results(tasks):
    ...
    for task in tasks:
        ...
        save_name = (
            "SnP_mono_gte-multilingual-base"
            + "-".join(levels.keys())
            + eval_dataset
    ...
    save_name_predictions = "MONO_gte-multilingual-base_all_predictions.csv"
    ...
    tasks = [
        {
            ...
            "prefixes": [
                "Alibaba-NLP_gte-multilingual-base-mono_snp_real-10000-samples-seed",
            ],
            "levels": {
