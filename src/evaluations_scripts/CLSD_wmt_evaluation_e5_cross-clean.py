# Paper: ACL 2025
# Evaluates: CLSD cross-noise evaluation with E5 (clean distractors)
import os
import pandas as pd
...
def process_and_save_results(tasks):
    ...
    for task in tasks:
        ...
        save_name = (
            "CROSS_CLEAN_e5-multilingual-base"
            + "-".join(levels.keys())
            + eval_dataset
    ...
    save_name_predictions = "CROSS_CLEAN_e5-multilingual-base_all_predictions.csv"
    ...
    tasks = [
        {
            ...
            "prefixes": [
                "intfloat_multilingual-e5-base-cross_clean-10000-samples-seed",
            ],
            "levels": {
