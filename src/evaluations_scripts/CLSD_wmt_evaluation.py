# Paper: ACL 2025
# Evaluates: CLSD cross-lingual semantic divergence on WMT adversarial data
import os
import pandas as pd
...
def process_and_save_results(tasks):
    ...
    # Save averaged results for this task
    save_name_predictions = "BASE_e5-multilingual-base_all_predictions.csv"
